...
//declaring the vairables
    ...
    public Email(String firstName, String lastName) {
        ...
        //getting the temporary auto generated password
        ...
        //if succssful login user will prompt to enter his new password
    ...
    private String generatePassword(int length) {
        ...
        for (int i = 0; i < password.length; i++) {
            //the generate a random password
            int random = (int) (Math.random() * passwordPermitedLetters.length());
            password[i] = passwordPermitedLetters.charAt(random);
        }

        //assimpling the passord in new string and store it password vairable
